# n8n import setup — Latin Heritage Month Innovation Summit
...
Clone `mishpe26` where n8n can run shell commands, e.g. `/opt/mishpe26`:

```bash
git clone https://github.com/Compass-Detroit/mishpe26.git /opt/mishpe26
cd /opt/mishpe26
npm ci
...
| Working directory | `/opt/mishpe26`       |

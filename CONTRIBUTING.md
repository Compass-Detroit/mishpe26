...
Thank you for your interest in contributing to the Detroit Pride Innovation Summit (`mishpe26`)! This document provides guidelines and information for contributors.
...
2. **Clone your fork** locally:
   ...
   ```bash
   git clone https://github.com/YOUR_USERNAME/mishpe26.git
   cd mishpe26
   ```
...
1. **Re-add the repo** so GitHub Desktop picks up the correct remote:
   ...
   - **File → Add Local Repository** and choose this project folder (`mishpe26`).
   - GitHub Desktop will use the existing Git remotes; pushes and "Create Pull Request" should now target **Compass-Detroit/mishpe26**.

2. **Confirm remotes in Terminal** (optional):
   ```bash
   git remote -v
   ```
   You should see `origin` (and optionally `upstream`) pointing to `https://github.com/Compass-Detroit/mishpe26.git`. If not:
   ```bash
   git remote set-url origin https://github.com/Compass-Detroit/mishpe26.git
   ```
